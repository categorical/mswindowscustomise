...
_2bin "$dopt/appnetworkcounter/appnetworkcounter.exe"
...
_2bin "$maintenancedir/backlog/msstartmenu.sh" "$bindir/msstartmenu"
_2bin "$maintenancedir/misc/firewall.sh" "$bindir/firewall"
